  ...
  return (
    <main className="narrow" style={{ padding: "72px 24px 100px" }}>
      ...
      <div style={{ display: "grid", gap: 22, maxWidth: "62ch" }} className="dim">
        ...
        <h2 className="display" style={{ fontSize: 24, color: "var(--ink)" }}>Who sees what</h2>
        <p>
          ...
          from search engines. We can&rsquo;t stop the other player taking a screenshot, so bring people you&rsquo;re
          comfortable sharing with them.
        </p>
        <h2 className="display" style={{ fontSize: 24, color: "var(--ink)" }}>Consent first</h2>
        <p>
        ...
        <h2 className="display" style={{ fontSize: 24, color: "var(--ink)" }}>How long things live</h2>
        <p>
          One-time rooms, including the photos, names, questions, and answers, are deleted 24 hours after the game ends or the
        ...
        <h2 className="display" style={{ fontSize: 24, color: "var(--ink)" }}>What we measure</h2>
        <p>
        ...
        <h2 className="display" style={{ fontSize: 24, color: "var(--ink)" }}>Your stories</h2>
        <p>
          The best part of the game, why you&rsquo;d call this person first or how you met, happens out loud on your
          call or across the table. The app never records it.
        </p>
      </div>
      <a className="btn paperline" href="/" style={{ marginTop: 36 }}>Back to the game</a>
    </main>
  );
}
